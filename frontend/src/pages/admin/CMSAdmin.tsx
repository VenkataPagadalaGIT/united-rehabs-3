...
export default function CMSAdmin() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: "Error",
        description: error.response?.data?.detail || "Failed to save page content",
        variant: "destructive",
      });
    },
  });
            ...
            <TabsContent key={page.slug} value={page.slug}>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <Card>
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription>
                        Enter HTML content for the page. Supports standard HTML tags.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      {isLoading ? (
                ...
                <div className="space-y-4">
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          id="published"
                          checked={isPublished}
                          onCheckedChange={(checked) => setEditedContent(prev => ({ ...prev, is_published: checked }))}
                        />
                      </div>
                      {pageContent?.version && (
                      ...
                      {pageContent?.last_edited_by && (
                        <p className="text-xs text-muted-foreground">
                          Last edited by: {pageContent.last_edited_by}
                        </p>
                      )}
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setEditedContent(prev => ({ ...prev, meta_title: e.target.value }))}
                  ...
                  <Card>
                    <CardHeader className="pb-3">
                      <CardTitle className="text-lg">HTML Reference</CardTitle>
                    </CardHeader>
